...
{
	DirectX::XMFLOAT4 yellow = DirectX::XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f);
	DirectX::XMFLOAT3 startPos(-0.95f, 0.90f, 0.0f);
...
void ScoreDisplay::SetPosition(DirectX::XMFLOAT3 v)
{
	GameObject::SetPosition(v);
	DirectX::XMFLOAT3 pos(v);
	for (int i = 0; i < NUM_DIGITS; i++)
	{
